...
INSERT INTO funcionarios (nome, CPF, data_nascimento, endereco,telefone,email, cargo,salario, data_admissao) VALUES
					     ('Ricardo Sousa','111.222.333-44','1992-05-12', 'Rua Harmonia 157,São Paulo','11987651234','ricardo.sousa@email.com','Chefe de Cozinha',6.000,'2019-03-15');
...
alter table clientes ADD COLUMN data_admissao DATE;

INSERT INTO clientes (nome, CPF, data_nascimento, endereco,telefone,email,data_admissao) VALUES
...
INSERT INTO info_produtos  (id_info, ingredientes, fornecedor) VALUES 
...
SELECT * FROM pedidos WHERE < '2024-07-06';
SET SQL_SAFE_UPDATES = 0;
